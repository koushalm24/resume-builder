...
function DetailsFillingPage() {
  ...
  return (
    <div>
      <div className="container text-center" style={{ maxWidth:"1920px",marginTop:"1px",backgroundColor:"#fafafa",}}>
        <div >
              <div className='row' style={{maxHeight:"none"}}>

                    <div id="side" className=" col-lg-3 col-sm-12 col-12 sidebar"  >
                    ...
                    <div className="content col-lg-9 col-sm-12 col-12" style={{}} >
