...
import {
  updatePersonalInfo,
  updateErrorMessages,
} from "../../ReduxManager/dataStoreSlice";
    ...
    <div style={{ padding: "15px", textAlign: "left" }}>
      <div>
            ...
            <div className="row ">
              ...
              <div className="col-sm-10 col-12">
                <TextField
                  ...
                  onChange={(value) => {
                    onChangeHandler("Address1", value);
                  }}
                />
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-10 col-12">
                <TextField
                  ...
                  onChange={(value) => {
                    onChangeHandler("Address2", value);
                  }}
                />
              </div>
            </div>
        ...
        <div className="col-lg-6 col-12 pt-5 px-4">
            <div className="row ">
              <div className="col-sm-2  col-12">
                <label htmlFor="inputState" className="col-sm-1 col-form-label">
                  State
                </label>
              </div>
              <div className="col-sm-10  col-12">
        ...
        <div className=" row font">
          <div className="col-lg-6 col-12 pt-5 px-4">
            <div className="row ">
              <div className="col-sm-2  col-12">
                <label htmlFor="pin" className="col-sm-1 col-form-label">
                  Pincode
                </label>
              </div>
              <div className="col-sm-10  col-12">
